...
cd /home/estelle/dotfiles || { echo "dotfiles directory not found!"; exit 1; }
...
commit_and_push /home/estelle/dotfiles

# Commit and push submodules
commit_and_push users/estelle
commit_and_push hosts/linouce
